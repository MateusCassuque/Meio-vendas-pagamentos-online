<template>
    <div>
        ...
        <v-card class="">
            ...
            <v-card-subtitle> <p class="subTitle"> {{ $store.state.auth.user.email }} </p> </v-card-subtitle>
        ...
        <v-bottom-navigation class="nave">
            <v-btn-toggle>
                ...
                <v-btn class="actionBtn text-caption text-md-auto" to="/user/sobre" router
                color="secondary"> 
